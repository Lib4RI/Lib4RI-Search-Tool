...
// if ( ( $got = @strip_tags($_GET['js']) ) && $got != 'no' ) {
		echo '<script type="text/javascript" src="' . $host . '/web/js/lib4ri-websearch.js?t=' . $got . '"></script>' . "\r\n";
// }
?>
	...
	<div id="lib4ri-tab-container" style="display:none;"><!-- revealed on search start -->
		...
		<div id="lib4ri-result-container-1" class="lib4ri-result-container">
			...
			<div class="lib4ri-search-col lib4ri-search-col-2">
				...
				<div class="lib4ri-bentobox-container">
					...
					<div id="lib4ri-bentobox-linkset-1-2-4" class="lib4ri-bentobox-linkset" data-api="references:main:Britannica;references:Science & Technology:ChemSpider;references:Science & Technology:Elsevier Reference;references:Science & Technology:Springer Materials;references:Science & Technology:Springer Reference;references:Science & Technology:Wiley Reference"><div class="lib4ri-search-anim-block">&nbsp;</div></div>
				</div>
				<div class="lib4ri-bentobox-container">
		...
		<div id="lib4ri-result-container-2" class="lib4ri-result-container" style="display:none;">
			...
			<div class="lib4ri-search-col lib4ri-search-col-1to2">
				...
				<div class="lib4ri-bentobox-container">
					<label class="lib4ri-bentobox-label" id="lib4ri-bentobox-label-2-1-1" data-api="Journal List">Lib4RI&#39;s Online Journals</label>
